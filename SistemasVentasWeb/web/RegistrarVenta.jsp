<%-- 
    ...
    Created on : 25/05/2021, 08:32:08 PM
    Author     : ARTURO CRUZ
--%>
                 ...
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <div class="form-group d-flex">
                             ...
                             <div class="col-sm-6">
                                 <input type="text" name="nombresclientes" value="${c.getNom()}" placeholder="Datos Cliente" class="form-control col-sm-12">
                             </div> 
                         </div> 
                             <!-- DATOS DEL PRODUCTO-->
                         <div class="form-group">
                              <label>Datos Produto</label>
                         </div> 
                         <div class="form-group d-flex">
                             <div class="col-sm-6 d-flex">
                             ...
                             <div class="col-sm-6">
                                 <input type="text" name="nomproducto" value="${producto.getNom()}" placeholder="Datos Producto" class="form-control col-sm-12">
                             </div> 
                         </div> 
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td class="d-flex">
                                         ...
                                         <a href="#" class="btn btn-danger" style="margin-left:100  px">Delete</a>
                                     </td>
                                 </tr>
                                 </c:forEach>
                             </tbody>
